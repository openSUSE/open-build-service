...
Requires:       rubygem(2.0.0:bootstrap-sass) = 2.3.2.2
BuildRequires:  rubygem(2.0.0:bootstrap-sass) = 2.3.2.2
Requires:       rubygem(2.0.0:kgio) = 2.8.1
BuildRequires:  rubygem(2.0.0:kgio) = 2.8.1
Requires:       rubygem(2.0.0:raindrops) = 0.12.0
BuildRequires:  rubygem(2.0.0:raindrops) = 0.12.0
Requires:       rubygem(2.0.0:unicorn) = 4.6.3
BuildRequires:  rubygem(2.0.0:unicorn) = 4.6.3
Requires:       rubygem(2.0.0:unicorn-rails) = 1.1.0
BuildRequires:  rubygem(2.0.0:unicorn-rails) = 1.1.0
...
mv log/test.log{,.old}
if ! echo bundle exec rake --trace test; then
  cat log/test.log
  exit 1
fi
popd
