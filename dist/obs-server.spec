...
for i in obssrcserver obsrepserver obsscheduler obsworker obspublisher obsdispatcher obssigner obswarden ; do
...
%preun
#-------------------------------------------------------------------------------
for service in obssrcserver obsrepserver obssigner obswarden obsdispatcher obsscheduler obspublisher; do
