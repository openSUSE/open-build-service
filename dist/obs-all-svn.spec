...
cp -a Build.pm build createrpmdeps order getbinaryid expanddeps extractbuild getmacros getoptflags init_buildsystem initscript_qemu_vm substitutedeps computeblocklists vc $RPM_BUILD_ROOT/usr/lib/build/
