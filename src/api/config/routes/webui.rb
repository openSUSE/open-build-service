...
constraints(RoutesHelper::WebuiMatcher) do
  ...
  resources :projects, only: [], param: :name do
    ...
    resource :contribution_guide, controller: 'webui/projects/contribution_guide', only: %i[show edit update], constraints: cons
    ...
    resources :packages, only: [], param: :name do
      ...
      resource :contribution_guide, controller: 'webui/packages/contribution_guide', only: %i[show edit update], constraints: cons
