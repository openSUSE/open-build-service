  ...
  def initialize
    ...
    @attribs = {
      ...
      'requests' => {
        ...
        'review/@by_user' => { cpart: 'r_user.by_user', joins: 'LEFT JOIN reviews r_user ON r_user.bs_request_id = bs_requests.id' },
        'review/@by_group' => { cpart: 'r_group.by_group', joins: 'LEFT JOIN reviews r_group ON r_group.bs_request_id = bs_requests.id' },
        'review/@by_project' => { cpart: 'r_project.by_project', joins: 'LEFT JOIN reviews r_project ON r_project.bs_request_id = bs_requests.id' },
        'review/@by_package' => { cpart: 'r_package.by_package', joins: 'LEFT JOIN reviews r_package ON r_package.bs_request_id = bs_requests.id' },
