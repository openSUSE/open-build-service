namespace :assets do
  ...
  task resprite: :environment do
    ...
    SpriteFactory.run!('app/assets/images/icons', output_style: 'app/assets/stylesheets/webui/icons.scss',
                                                  output_image: 'app/assets/images/icons_sprite.png',
                                                  margin: 2, nocomments: true) do |images|
      rules = []
