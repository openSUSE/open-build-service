namespace :dev do
  namespace :staging do
    ...
    task data: :development_environment do
      ...
      staging_workflow = create(:staging_workflow_with_staging_projects, project: maintainer.home_project,
      ...
      staging_workflow.staging_projects.each do |staging_project|
        2.times do |i|
          RakeSupport.request_for_staging(staging_project, maintainer.home_project,
                                          "#{staging_project.id}_#{timestamp}_#{i}")
        end
      end
