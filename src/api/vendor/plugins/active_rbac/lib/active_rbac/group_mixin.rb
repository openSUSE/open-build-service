...
module ActiveRbacMixins
  ...
  #
  # Here, create the Group class and import the GroupMixin module, e.g.:
  #
  #   class Group < ActiveRecord::Base
  #     include ActiveRbacMixins::GroupMixin
  #
  ...
  module GroupMixin
    ...
    # including class behave like ActiveRBAC's Group class.
