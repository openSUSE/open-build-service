...
RSpec.describe Webui::Packages::MetaController, :vcr do
  ...
  describe 'GET #show' do
    ...
    it { expect(response).to render_template('packages/meta/show') }
  ...
  describe 'PUT #update' do
    ...
    context 'with an invalid package name' do
      before do
        put :update, params: { project_name: source_project, package_name: source_package, meta: invalid_meta_because_package_name }
      end
