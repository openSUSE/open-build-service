RSpec.describe Webui::DistrosController do
  ...
  describe 'POST #create' do
    ...
    let(:distro_params) { { name: 'Tumbleweed', url: 'https://get.opensuse.org' } }
    ...
    context 'as a project maintainer' do
      ...
      context 'with a name already taken within the same vendor' do
        ...
        it 'sets a human readable error flash' do
          subject
          expect(flash[:error]).to eq('Distro failed to create. Name has already been taken.')
        end
      end
    end
  ...
  describe 'PATCH #update' do
    ...
    context 'as a project maintainer' do
      ...
      context 'with a name already taken within the same vendor' do
        ...
        it 'sets a human readable error flash' do
          subject
          expect(flash[:error]).to eq('Distro failed to update. Name has already been taken.')
        end
      end
