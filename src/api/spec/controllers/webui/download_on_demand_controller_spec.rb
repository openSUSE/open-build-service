RSpec.describe Webui::DownloadOnDemandController do
  ...
  describe 'POST create' do
    ...
    context 'invalid architecture parameter' do
      ...
      it {
        expect(flash[:error]).to eq("Download on Demand can't be created: Validation failed: Architecture must exist")
      }
  ...
  describe 'DELETE destroy' do
    ...
    context 'invalid requests' do
      ...
      it {
        expect(flash[:error]).to eq("Download on Demand can't be removed: DoD Repositories must have at least one repository.")
      }
