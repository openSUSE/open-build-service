...
class Webui::AllRoutesTest < Webui::IntegrationTest
  ...
  test "visit all routes" do
    ...
    urls << webui_engine.url_for(controller: "/webui/package", action: :show, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :dependency, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :binary, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :binaries, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :users, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :requests, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :statistics, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :commit, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :revisions, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :submit_request, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :add_person, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :add_group, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :rdiff, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :wizard_new, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :wizard, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :save_new, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :branch_dialog, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :branch, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :save_new_link, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :save, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :remove, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :add_file, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :save_file, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :remove_file, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :save_person, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :save_group, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :remove_role, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :view_file, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :save_modified_file, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :update_build_log, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :abort_build, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :trigger_rebuild, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :wipe_binaries, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :buildresult, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :rpmlint_result, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :rpmlint_log, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :meta, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :save_meta, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :attributes, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :edit, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :repositories, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :change_flag, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :import_spec, project: 'kde4', package: 'kdelibs4')
    urls << webui_engine.url_for(controller: "/webui/package", action: :files, project: 'kde4', package: 'kdelibs4')
