...
# end
  ...
  test "revert to revision" do
    ...
    6.times { |i| put '/source/BaseDistro2.0/tst_pack/rev_file_test', "revision #{(i + 1).to_s}" }
    ...
    page.wont_have_selector '.dialog' # wait for the reload
    flash_message.must_match %r{Created submit request \d* to BaseDistro2.0}
