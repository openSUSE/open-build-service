...
class SourceControllerTest < ActionDispatch::IntegrationTest
  ...
  def test_linked_project_operations_with_foreign_sources
    ...
    put '/source/home:tom:LINK/_meta', params: "<project name='home:tom:LINK'> <title/> <description/> <link project='RemoteInstance:BaseDistro2.0'/> <repository name='dummy'> <arch>x86_64</arch> </repository> </project>"
    assert_response :success
