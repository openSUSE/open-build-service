...
class AttributeTest < ActiveSupport::TestCase
  ...
  def test_list
    ...
    assert_equal atypes, ["ApprovedRequestSource", "BranchTarget", "OwnerRootProject", "InitializeDevelPackage", "Maintained", "MaintenanceIdTemplate", "MaintenanceProject", "ProjectStatusPackageFailComment", "QualityCategory", "RejectRequests", "RequestCloned", "ScreenShots", "UpdateProject", "VeryImportantProject", "status"]
