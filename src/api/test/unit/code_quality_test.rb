...
class CodeQualityTest < ActiveSupport::TestCase
  ...
  BlackList = {
    ...
    'BsRequestAction#sourcediff' => 263.6,
    ...
    'SourceController#delete_package' => 87.83,
  ...
  test "code complexity" do
    ...
    flog.each_by_score do |class_method, score, call_list|
      ...
      assert !oldscore.nil?, "#{class_method} is not in the blacklist and has a score of #{score}"
