...
class CodeQualityTest < ActiveSupport::TestCase
  ...
  BlackList = {
      ...
      'BinaryRelease#render_xml' => 53.89,
      ...
      'BsRequestPermissionCheck#cmd_changereviewstate_permissions' => 73.74,
      ...
      'RequestController#request_command' => 71.88,
      'SearchController#find_attribute' => 97.33,
      'SearchController#search' => 69.57,
      ...
      'Webui::PackageController#submit_request' => 130.27,
      ...
      'Webui::RequestController#add_role_request' => 62.08, 
      'Webui::RequestController#change_devel_request' => 52.83,
      'Webui::RequestController#forward_request_to' => 64.18, 
      'Webui::RequestController#set_bugowner_request' => 57.53,
      'Webui::RequestController#delete_request' => 60.33, 
