class Webui::Attribute < Webui::Node
  ...
  def save
    ...
    if package
      path = "/source/#{self.init_options[:project]}/#{self.init_options[:package]}/_attribute"
    else
      path = "/source/#{self.init_options[:project]}/_attribute"
    end
