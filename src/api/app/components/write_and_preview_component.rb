class WriteAndPreviewComponent < ApplicationComponent
  ...
  def initialize(form:, preview_message_url:, message_body_param:, canned_responses_enabled: false, canned_response_object: nil, text_area_rows: 4, text_area_required: true, text_area_object_name: :message, text_area_id_suffix: :message) # rubocop:disable Layout/LineLength
    super()
