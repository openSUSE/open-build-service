...
class Package < ApplicationRecord
  ...
  def self.get_by_project_and_name(project_name, package_name, opts = {})
    ...
    if package.nil? && opts[:follow_special_names]
      # FIXME: What about _product, _pattern and _patchinfo?
      # There are packages in production that just have one of those strings in the `name`` column.
      # Are they special somehow?
      return if package_name != '_project'
