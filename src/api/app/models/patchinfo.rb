...
class Patchinfo < ActiveXML::Node
  ...
  def create_patchinfo_from_request(project, req)
    ...
    Backend::Api.write_patchinfo(@pkg.project.name, @pkg.name, User.current.login, xml.dump_xml, "generated by request id #{req.number} accept call")
    @pkg.sources_changed
  end
  ...
  def create_patchinfo(project, pkg_name, opts = {})
    ...
    if CONFIG['global_write_through']
      Backend::Api.write_patchinfo(@pkg.project.name, @pkg.name, User.current.login, xml.dump_xml, 'generated by createpatchinfo call')
    end
    @pkg.sources_changed
