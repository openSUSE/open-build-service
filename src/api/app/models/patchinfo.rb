...
class Patchinfo < ActiveXML::Node
  ...
  def create_patchinfo_from_request(project, req)
    ...
    Backend::Connection.put(patchinfo_url(@pkg, "generated by request id #{req.number} accept call"), xml.dump_xml)
    @pkg.sources_changed
  end
  ...
  def create_patchinfo(project, pkg_name, opts = {})
    ...
    if CONFIG['global_write_through']
      Backend::Connection.put(patchinfo_url(@pkg, 'generated by createpatchinfo call'), xml.dump_xml)
    end
    @pkg.sources_changed
  ...
  def patchinfo_url(pkg, comment)
    ...
    path << Backend::Connection.build_query_from_hash(p, [:user, :comment])
  end
  ...
  def cmd_update_patchinfo(project, package)
    ...
    Backend::Connection.put(patchinfo_url(pkg, 'updated via updatepatchinfo call'), xml.dump_xml)
    pkg.sources_changed
  end
