class BsRequestActionMaintenanceIncident < BsRequestAction
  ...
  def modify_sources(force_branching)
    ...
    Project.transaction do
      ...
      stage_project_name = User.session!.branch_project_name("MAINTENANCE_REQUEST:#{bs_request.number}")
  ...
  def _merge_pkg_into_maintenance_incident(incident_project)
    ...
    set_acceptinfo(result['acceptinfo']) if bs_request.number && new_pkg.project.is_maintenance_incident?
