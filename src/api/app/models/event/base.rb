...
module Event
  class Base < ApplicationRecord
    ...
    EXPLANATION_FOR_NOTIFICATIONS =  {
      Event::BuildFail.to_s => 'Receive notifications for build failures of packages for which you are...',
      Event::ServiceFail.to_s => 'Receive notifications for source service failures of packages for which you are...',
      Event::ReviewWanted.to_s => 'Receive notifications for reviews created that have you as a wanted...',
      Event::RequestCreate.to_s => 'Receive notifications for requests created for projects/packages for which you are...',
      Event::RequestStatechange.to_s => 'Receive notifications for requests state changes for projects for which you are...',
      Event::CommentForProject.to_s => 'Receive notifications for comments created on projects for which you are...',
      Event::CommentForPackage.to_s => 'Receive notifications for comments created on a package for which you are...',
      Event::CommentForRequest.to_s => 'Receive notifications for comments created on a request for which you are...',
      Event::RelationshipCreate.to_s => "Receive notifications when someone adds you or your group to a project or package with any of these roles: #{Role.local_roles.to_sentence}.",
      Event::RelationshipDelete.to_s => "Receive notifications when someone removes you or your group from a project or package with any of these roles: #{Role.local_roles.to_sentence}.",
      Event::ReportForComment.to_s => 'Receive notifications for reported comments.',
      Event::ReportForPackage.to_s => 'Receive notifications for reported packages.',
      Event::ReportForProject.to_s => 'Receive notifications for reported projects.',
      Event::ReportForUser.to_s => 'Receive notifications for reported users.',
      Event::ReportForRequest.to_s => 'Receive notifications for reported requests.',
      Event::ClearedDecision.to_s => 'Receive notifications for cleared report decisions.',
      Event::FavoredDecision.to_s => 'Receive notifications for favored report decisions.',
      Event::WorkflowRunFail.to_s => 'Receive notifications for failed workflow runs on SCM/CI integration.',
      Event::AppealCreated.to_s => 'Receive notifications when a user appeals against a decision of a moderator.',
      Event::AddedUserToGroup.to_s => 'Receive notifications when you are added to a group.',
      Event::RemovedUserFromGroup.to_s => 'Receive notifications when you are removed from a group.'
    }.freeze
