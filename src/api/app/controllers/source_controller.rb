...
class SourceController < ApplicationController
  ...
  def _check_single_target!(source_repository, target_repository, architecture_filter)
    ...
    source_repository.check_valid_release_target!(target_repository, architecture_filter)
  end
