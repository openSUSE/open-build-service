      ...
      data.elements("partition") do |partition|
        partition.elements("daemon") do |daemon|
          ...
          if @architecture
            ...
            @architecture = Architecture.create(:name => arch_name, :recommended => false, :available => daemon["state"])
          end
        end
      end
    end
