...
function handlingCommentEvents() {
  ...
  const commentFieldSelector = '.comments-list .comment-field, .comment_new .comment-field, .timeline .comment-field, .diff .comment-field';
  ...
  const timelineDiffSelector = '.timeline .post-comment-form, .timeline .put-comment-form, .timeline .moderate-form, .diff .post-comment-form, .diff .put-comment-form, .diff .moderate-form';
