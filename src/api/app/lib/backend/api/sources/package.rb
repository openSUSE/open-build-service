  ...
  module Api
    module Sources
      ...
      module Package
        ...
        # @return [String]
        def self.write_meta(project_name, package_name, meta, options = {})
          http_put(['/source/:project/:package/_meta', project_name, package_name], data: meta, params: options, accepted: %i[user comment requestid])
        end
