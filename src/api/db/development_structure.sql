...
CREATE TABLE `path_elements` (
  ...
  CONSTRAINT `path_elements_ibfk_1` FOREIGN KEY (`repository_id`) REFERENCES `repositories` (`id`),
  CONSTRAINT `path_elements_ibfk_2` FOREIGN KEY (`parent_id`) REFERENCES `repositories` (`id`),
...
INSERT INTO schema_migrations (version) VALUES ('2147483647');
