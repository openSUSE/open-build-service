class AddMaintainerAttribType  < ActiveRecord::Migration
  ...
  def self.up
    ...
    self.transaction do
      at=AttribType.create( :attrib_namespace => ans, :name => "Maintainer" )
  ...
  def self.down
    AttribType.find_by_namespace_and_name("OBS", "Maintainer").destroy()
  end
