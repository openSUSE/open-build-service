class ChangeCharset < ActiveRecord::Migration
  def self.up
    execute("alter database #{ActiveRecord::Base.connection.current_database} charset=utf8;")
    ...
    %w{architectures architectures_repositories attrib_allowed_values attrib_default_values 
      ...
      execute("alter table #{tbl} charset=utf8;")   
    end
  end
