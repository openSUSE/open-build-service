class RemoveDuplicateIndexes < ActiveRecord::Migration
  def self.up
    ...
    # To remove this duplicate index, execute:
    execute "ALTER TABLE `bs_request_actions` DROP INDEX `index_bs_request_actions_on_target_project`;"
  ...
  def self.down
    ...
    execute "ALTER TABLE `bs_request_actions` ADD INDEX `index_bs_request_actions_on_target_project` (`target_project`);"
