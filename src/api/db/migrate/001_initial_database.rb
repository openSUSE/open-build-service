class InitialDatabase < ActiveRecord::Migration[6.0]
  def self.up
    ...
    create_table 'backend_packages', primary_key: 'package_id', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
                                     force: :cascade do |t|
    ...
    create_table 'data_migrations', primary_key: 'version', id: :string, collation: 'utf8_general_ci',
                                    options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC', force: :cascade do |t|
    end
