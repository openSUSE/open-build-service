...
CREATE TABLE `reviews` (
  ...
  CONSTRAINT `fk_rails_230406b5be` FOREIGN KEY (`package_id`) REFERENCES `packages` (`id`),
  CONSTRAINT `fk_rails_64798be025` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`),
  ...
  CONSTRAINT `fk_rails_e63e17ff06` FOREIGN KEY (`group_id`) REFERENCES `groups` (`id`),
