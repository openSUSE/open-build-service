...
CREATE TABLE `binary_releases` (
  ...
  `operation` smallint(6) DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE `release_targets` (
  ...
  `trigger` smallint(6) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `repositories` (
  ...
  `rebuild` smallint(6) DEFAULT NULL,
  `block` smallint(6) DEFAULT NULL,
  `linkedbuild` smallint(6) DEFAULT NULL,
  PRIMARY KEY (`id`),
