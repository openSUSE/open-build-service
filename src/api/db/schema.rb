...
ActiveRecord::Schema.define(:version => 20100928081344) do
  ...
  add_index "db_packages", ["db_project_id", "name"], :name => "packages_all_index", :unique => true, :length => {"name"=>"255", "db_project_id"=>nil}
  ...
  add_index "db_projects", ["name"], :name => "projects_name_index", :unique => true, :length => {"name"=>"255"}
  ...
  add_index "flags", ["flag"], :name => "index_flags_on_flag"
  ...
  add_index "status_histories", ["key"], :name => "index_status_histories_on_key"
  ...
  add_index "users", ["login"], :name => "users_login_index", :unique => true, :length => {"login"=>"255"}
