...
class AddSkipChannelBranch < ActiveRecord::Migration[6.0]
  def self.up
    ans = AttribNamespace.find_by_name('OBS')

    AttribTypeModifiableBy.reset_column_information

    at = AttribType.find_or_create_by(attrib_namespace: ans, name: 'SkipChannelBranch')
  ...
  def self.down
    AttribType.find_by_namespace_and_name('OBS', 'SkipChannelBranch').delete
  end
end
