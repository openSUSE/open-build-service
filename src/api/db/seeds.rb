...
IssueTracker.where(name: 'boo').first_or_create(description: 'openSUSE Bugzilla', enable_fetch: true, kind: 'bugzilla', regex: '(?:bnc|BNC|bsc|BSC|boo|BOO)\s*[#:]\s*(\d+)', url: 'https://bugzilla.opensuse.org/', label: 'boo#@@@', show_url: 'https://bugzilla.opensuse.org/show_bug.cgi?id=@@@')
