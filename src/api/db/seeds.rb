...
IssueTracker.find_or_create_by_name('bnc', :description => 'Novell Bugzilla', :kind => 'bugzilla', :regex => 'bnc#(\d+)', :url => 'https://bugzilla.novell.com/', :long_name => "bnc#%s", :show_url => 'https://bugzilla.novell.com/show_bug.cgi?id=@@@')
