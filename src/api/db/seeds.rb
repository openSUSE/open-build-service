...
it = IssueTracker.find_or_create_by_name('cve', :description => 'CVE Numbers', :kind => 'cve', :regex => 'CVE-\d{4,4}-\d{4,4}', :url => 'http://cve.mitre.org/', :show_url => 'http://cve.mitre.org/cgi-bin/cvename.cgi?name=@@@')
