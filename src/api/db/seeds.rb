...
IssueTracker.where(name: 'fate').first_or_create(description: 'openSUSE Feature Database', kind: 'fate', regex: '[Ff]ate\s+#\s+(\d+)', url: 'https://features.opensuse.org/', label: 'fate#@@@', show_url: 'https://features.opensuse.org/@@@')
