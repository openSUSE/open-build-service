...
class VCR::RequestMatcherRegistry::Matcher < Anonymous_Struct_31
...
class VCR::RequestMatcherRegistry::URIWithoutParamsMatcher < Anonymous_Struct_32
...
class VCR::Request < Anonymous_Struct_33
  def initialize(*args); end
  def method(*args); end
  def parsed_uri; end
...
class VCR::Request::Typed < Anonymous_Delegator_34
...
class VCR::Request::FiberAware < Anonymous_Delegator_35
  def proceed; end
  def to_proc; end
end
...
class VCR::Response < Anonymous_Struct_36
  def compressed?; end
...
class VCR::ResponseStatus < Anonymous_Struct_37
  def self.from_hash(hash); end
  def to_hash; end
end
...
class VCR::HTTPInteraction < Anonymous_Struct_38
  def hook_aware; end
  def initialize(*args); end
  def self.from_hash(hash); end
  def to_hash; end
end
class VCR::HTTPInteraction::HookAware < Anonymous_Delegator_39
