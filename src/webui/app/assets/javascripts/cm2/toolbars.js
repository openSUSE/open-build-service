...
(function() {
	...
	function getPosition(cm) {
		this.cm = cm;
		this.position = this.cm.getCursor(true);
		this.position.line += this.cm.getOption('firstLineNumber');
		if(document.getElementById('ln_'+this.cm.id) != null) document.getElementById('ln_'+this.cm.id).innerHTML = this.position.line;
		if(document.getElementById('ch_'+this.cm.id) != null) document.getElementById('ch_'+this.cm.id).innerHTML = this.position.ch;
	...
	function Match(cm, elt) {
		this.cm = cm;
		if(elt.value == 'on') {
			this.position = this.cm.getCursor(false);
			this.cm.setCursor(this.position);
		}
		elt.value  = elt.value == 'on' ? 'off'   : 'on' ;
	}
