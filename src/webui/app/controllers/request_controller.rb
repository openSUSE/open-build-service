    ...
    @req.each_review do |review|
      ...
      if session[:login]
        ...
        if (review.has_attribute? :by_group and user.is_in_group? review.by_group) or
           ...
           (review.has_attribute? :by_project and user.is_maintainer? review.by_project and review.has_attribute? :by_package and user.is_maintainer? (review.by_project, review.by_package))
