...
class SpiderTest < ActionController::IntegrationTest
  ...
  def test_1spider
     get("/")
     setup_spider(:ignore_urls => [%r{irc:.*}, %r{bugzilla.novell.com}, %r{hermes.opensuse.org}, '/user/logout', %r{/project/linking_projects}, %r{/package/linking_packages}], :verbose => false )
